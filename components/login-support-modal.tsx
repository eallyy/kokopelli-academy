    ...
    <>
      ...
      <Dialog open={isOpen} onClose={setIsOpen}>
        ...
        <DialogBody className="text-sm/6 text-zinc-900 dark:text-white">
          <p className="mt-4">
            Güvenlik nedeniyle (<Link href="https://tr.wikipedia.org/wiki/Tekrarlama_sald%C4%B1r%C4%B1s%C4%B1" className="underline text-sky-500">tekrarlama saldırılarını</Link> önlemek için), cihazınızın saatinin doğru olması çok önemlidir. En iyi yöntem, saatinizi otomatik olarak ayarlanacak şekilde ayarlamaktır.
          </p>
          <p className="mt-4">
          ...
          <p className="mt-4">
            ...
            Lütfen bizimle iletişime geçin: <Link href="mailto:destek@kokopelliakademi.com" className="underline text-sky-500">destek@kokopelliakademi.com</Link>
          </p>
        </DialogBody>
      </Dialog>
    </>
