...
export function LoginSupportModal() {
  ...
  return (
    <>
      <Button className="w-fit cursor-pointer" type="button" plain onClick={() => setIsOpen(true)}>
      ...
      <Dialog open={isOpen} onClose={setIsOpen}>
        ...
        <DialogBody className="text-sm/6 text-zinc-900 dark:text-white">
          <p className="mt-4">
            Güvenlik nedeniyle (<a target="_blank" href="https://tr.wikipedia.org/wiki/Tekrarlama_sald%C4%B1r%C4%B1s%C4%B1" className="underline text-sky-500">tekrarlama saldırılarını</a> önlemek için), cihazınızın saatinin doğru olması çok önemlidir. En iyi yöntem, saatinizi otomatik olarak ayarlanacak şekilde ayarlamaktır.
          </p>
          <p className="mt-4">
          ...
          <p className="mt-4">
            ...
            Lütfen bizimle iletişime geçin: <a href="mailto:destek@kokopelliakademi.com" className="underline text-sky-500">destek@kokopelliakademi.com</a>
          </p>
        </DialogBody>
      </Dialog>
    </>
